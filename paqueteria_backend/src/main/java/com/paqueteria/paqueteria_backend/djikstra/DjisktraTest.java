...
public class DjisktraTest {
    ...
    public DjisktraTest(String origen, String destino, SucursalRepositorio sucursalRepositorio){
    ...
    private void getSucursales(){
        ...
        this.listaSucursales= this.sucursalRepositorio.findByEstado(true);
    }

    public void dijkstra(int[][] graph, int source, int target) {
        int V = graph.length;
