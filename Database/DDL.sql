...
-- dom 15 oct 2023 22:09:13
=======
-- dom 15 oct 2023 22:32:06
>>>>>>> Stashed changes
...
CREATE TABLE IF NOT EXISTS `paqueteria`.`Departamento` (
  ...
  `idDepartamento1` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `paqueteria`.`Vehiculo_Sucursal` (
  `idVehiculoSucursal` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `paqueteria`.`Envio` (
  ...
  CONSTRAINT `fk_Envio_UsuarioEmisor`
    ...
    REFERENCES `paqueteria`.`Usuario` (`idUsuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
