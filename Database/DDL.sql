...
CREATE TABLE IF NOT EXISTS `mydb`.`PasosEnvio` (
  ...
  PRIMARY KEY (`idPasosEnvio`),
  INDEX `fk_PasosEnvio_1_idx` (`idEnvio` ASC) VISIBLE,
  INDEX `fk_PasosEnvio_2_idx` (`idSucursal` ASC) VISIBLE,
  CONSTRAINT `fk_PasosEnvio_1`
    FOREIGN KEY (`idEnvio`)
    REFERENCES `paqueteria`.`Envio` (`idEnvio`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_PasosEnvio_2`
